...
class SearchTest extends TestCase
{
    ...
    protected static function indexDocuments(): Search
    {
        ...
        $docs = [
            ['insert' => ['index' => 'movies', 'id' => 2, 'doc' => ['title' => 'Interstellar',
            ...
            ['insert' => ['index' => 'movies', 'id' => 3, 'doc' => ['title' => 'Inception', 'plot' => 'A thief who steals corporate secrets through the use of' .
            ...
            ['insert' => ['index' => 'movies', 'id' => 4, 'doc' => ['title' => '1917 ', 'plot' => ' As a regiment assembles to wage war deep in enemy territory, two' .
            ...
            ['insert' => ['index' => 'movies', 'id' => 5, 'doc' => ['title' => 'Alien', 'plot' => ' After a space merchant vessel receives an unknown transmission as a' .
            ...
            ['insert' => ['index' => 'movies', 'id' => 6, 'doc' => ['title' => 'Aliens', 'plot' => ' Ellen Ripley is rescued by a deep salvage team of explorers after' .
            ...
            ['insert' => ['index' => 'movies', 'id' => 10, 'doc' => ['title' => 'Alien 3', 'plot' => 'After her last encounter, without a team Ellen Ripley team of ' .
     ...
     * @param bool $sort since Manticore 4 we don't implicitly sort by id, so the results can be sorted
    ...
    public function testSearchDistanceMethod()
    {
        $result = self::$search->distance([
            'location_anchor' => ['lat' => 52.2, 'lon' => 48.6],
